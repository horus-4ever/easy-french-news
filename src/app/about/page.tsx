    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-12 px-6 container mx-auto">
        ...
        <p className="text-gray-700 text-lg leading-7">
          The <strong>French Easy News App</strong> bridges the language gap for
      ...
      <section className="py-12 px-6 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="p-6 bg-gray-50 shadow-lg rounded-lg">
            <h3 className="font-semibold text-lg mb-3">📄 Simplified News</h3>
          ...
          <div className="p-6 bg-gray-50 shadow-lg rounded-lg">
            <h3 className="font-semibold text-lg mb-3">🗣️ Audio Support</h3>
            <p className="text-gray-600">
          ...
          <div className="p-6 bg-gray-50 shadow-lg rounded-lg">
            <h3 className="font-semibold text-lg mb-3">📚 Vocabulary</h3>
            <p className="text-gray-600">
          ...
          <div className="p-6 bg-gray-50 shadow-lg rounded-lg">
            <h3 className="font-semibold text-lg mb-3">📖 Grammar Learning</h3>
            <p className="text-gray-600">
          ...
          <div className="p-6 bg-gray-50 shadow-lg rounded-lg">
            <h3 className="font-semibold text-lg mb-3">📝 Quiz</h3>
            <p className="text-gray-600">
      ...
      {/* Tech Stack Section */}
      <section className="py-12 px-6 container mx-auto bg-gray-100">
